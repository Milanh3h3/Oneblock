...
execute as @e[type=enderman,tag=!angered, limit = 2] run data modify entity @s AngryAt set from entity @p UUID
tag @e[type=enderman,tag=!angered, limit = 2] add angered
